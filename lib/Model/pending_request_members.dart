...
/// FirstName : "Harshil"
/// LastName : "Barad"
/// Person_TOwner : "baradharshil2015@gmail.com"
/// Org_Id : 5
...
/// Dept_Req : null
/// TStamp : "2023-12-04T05:00:18.4880762"
/// TOwner : "SuperAdmin@gmail.com"

class PendingRequestMemberModel {
  PendingRequestMemberModel({
      int? personId, 
      String? firstName, 
      String? lastName, 
      String? personTOwner, 
  ...
  PendingRequestMemberModel.fromJson(dynamic json) {
  ...
  String? _tStamp;
  String? _tOwner;
PendingRequestMemberModel copyWith({  int? personId,
  String? firstName,
  String? lastName,
  String? personTOwner,
  int? orgId,
  ...
  String? tStamp,
  String? tOwner,
}) => PendingRequestMemberModel(  personId: personId ?? _personId,
