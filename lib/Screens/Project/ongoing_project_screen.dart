...
import 'package:versa_tribe/Screens/Project/manage_project_screen.dart';
                  ...
                  return val.getProjectList.isNotEmpty ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        ...
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => ManageProjectScreen(projectResponseModel: val.getProjectList[index])));
                        },
                      );
                    },
                  ) : SizedBox(
